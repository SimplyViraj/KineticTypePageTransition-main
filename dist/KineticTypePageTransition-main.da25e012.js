...
})({"hyyV5":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "e69a3ed0da25e012";
"use strict";
...
const init = ()=>{
    ...
    const xTo = (0, _gsap.gsap).quickTo('.pov-pan', 'x', {
        duration: 1.3,
        ease: 'expo'
    });
    const yTo = (0, _gsap.gsap).quickTo('.pov-pan', 'y', {
        duration: 1.3,
        ease: 'expo'
    });
    ...
    _proto3.render = function render(totalTime, suppressEvents, force) {
        ...
        if (!dur) _renderZeroDurationTween(this, totalTime, suppressEvents, force);
            ...
            if (this._repeat) {
                ...
                if (iteration !== prevIteration) //repeatRefresh functionality
                {
...
},{"./gsap-core.js":"evdHe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"372oo":[function(require,module,exports,__globalThis) {
/*!
...
_revertRecorded = function _revertRecorded(media) {
    ...
    return (0, _observerJs._scrollers).forEach(function(obj) {
...
},{"./Observer.js":"d4t6P","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"d4t6P":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"c4OwT":[function(require,module,exports,__globalThis) {
/*!
...
},{"./utils/paths.js":"egr9q","./utils/matrix.js":"yTxrU","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"egr9q":[function(require,module,exports,__globalThis) {
/*!
 * paths 3.15.0
 * https://gsap.com
 *
...
parcelHelpers.export(exports, "flatPointsToSegment", ()=>flatPointsToSegment) // plots a number of points along the segment as evenly as possible while retaining non-smooth (angled) anchors.
;
parcelHelpers.export(exports, "segmentToDistributedPoints", ()=>segmentToDistributedPoints) //points is an array of x/y points, like [x, y, x, y, x, y]
;
...
function measureSegment(segment, startIndex, bezierQty) {
    ...
    for(j = startIndex + 2; j < endIndex; j += 6){
        ...
        y2 = segment[j + 1] - y1;
        xd = xd1 = yd = yd1 = 0;
        if (_abs(x4) < .01 && _abs(y4) < .01 && _abs(x2) + _abs(y2) < .01) // dump points that are close enough (basically right on top of each other, making a bezier super tiny or 0 length)
        {
            if (segment.length > 8) {
                segment.splice(j, 6);
                j -= 6;
...
function segmentToDistributedPoints(segment, totalPoints) {
    ...
    var samples = segment.samples, lookup = segment.lookup, resolution = segment.resolution, totalLength = segment.totalLength, points = segment.slice(0, 2), curveStoppingPoints = [], l = segment.length - 4, i = 6, limit = 0.2, startLength = 0, curvePointsCumulative = 0, t, curvePoints, min, max, ci, ratioInc, j, inv, curveLength, length, a, nonSmooth, curveStoppingPointIndex, sampleIndex; // first, loop through each anchor and find out if it's smooth (curve) or not by comparing the angle to each control point (if they're within a certain range, it's smooth). We want to keep pivot points (non-smooth) anchors but allow curved/smooth ones to be subject to simplification.
    for(; i < l; i += 6)if (Math.abs(_atan2(segment[i + 1] - segment[i - 1], segment[i] - segment[i - 2]) - _atan2(segment[i + 3] - segment[i + 1], segment[i + 2] - segment[i])) > limit) curveStoppingPoints.push(i);
    ...
    i = segment.length - 2;
    if (segment.closed && Math.abs(_atan2(segment[i + 1] - segment[i - 1], segment[i] - segment[i - 2]) - _atan2(segment[3] - segment[1], segment[2] - segment[0])) <= limit) nonSmooth[0] = nonSmooth[nonSmooth.length - 1] = 0;
    return points;
}
function pointsToSegment(points, curviness) {
    ...
    var l = points.length - 2, x = +points[0], y = +points[1], nextX = +points[2], nextY = +points[3], segment = [
        ...
        x,
        y
    ], dx2 = nextX - x, dy2 = nextY - y, nonSmooth = points.nonSmooth || [], // populated by segmentToDistributedPoints(). The x slot will have 1 if it's a non-smooth point, in which case we should skip the smoothing here, obviously.
    closed = Math.abs(points[l] - x) < 0.001 && Math.abs(points[l + 1] - y) < 0.001, prevX, prevY, i, dx1, dy1, r1, r2, r3, tl, mx1, mx2, mxm, my1, my2, mym;
    if (!l) return [
        x,
        y,
        x,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"yTxrU":[function(require,module,exports,__globalThis) {
/*!
 * matrix 3.15.0
 * https://gsap.com
 *
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["hyyV5","bMpAD"], "bMpAD", "parcelRequire5b73", {})

//# sourceMappingURL=KineticTypePageTransition-main.da25e012.js.map
